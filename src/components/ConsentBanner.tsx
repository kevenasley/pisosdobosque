    ...
    >
      ...
      <div className="flex items-center gap-2.5 md:hidden">
        ...
        <div className="flex shrink-0 flex-col gap-2">
          <button
            onClick={acceptAll}
            className="rounded-md bg-primary px-4 py-2 text-xs font-semibold text-primary-foreground shadow-sm active:scale-[0.97]"
          >
            Aceitar
          </button>
          <button
            onClick={rejectAll}
            className="rounded-md bg-[#F3F4F6] px-4 py-2 text-xs font-semibold text-foreground hover:bg-[#E5E7EB]"
          >
            Recusar
          </button>
        </div>
