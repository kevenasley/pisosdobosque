    ...
    <section id="top" className="relative overflow-hidden gradient-hero">
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 py-14 md:grid-cols-2 md:gap-16 md:px-8 md:py-20 lg:gap-20">
        <Reveal className="text-center text-white md:text-left">
          ...
          <h1 className="font-display text-[2rem] font-bold leading-[1.15] [text-wrap:balance] md:text-[2.75rem] lg:text-[3.25rem]">
      ...
      <div className="flex flex-1 flex-col p-4 text-center">
        ...
        <div className="mt-3 flex flex-1 flex-col justify-end">
          ...
          <a
            ...
            className="mt-3 inline-flex w-full items-center justify-center gap-1.5 rounded-md bg-brand-whatsapp px-4 py-2.5 text-xs font-semibold text-white shadow-sm transition hover:brightness-95"
          >
