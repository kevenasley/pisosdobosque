// Execute esta instrucao no projeto: Migração para backend via Supabase RPC (em substituição às Edge Functions bloqueadas) concluída. As rotas /api/dashboard/* foram removidas. O frontend agora utiliza chamadas diretas ao banco via RPC com autenticação JWT.
