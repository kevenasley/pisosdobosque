...
function ProductCard({ p }: { p: Product }) {
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col bg-[#F4F4F4] px-4 py-3 text-center">
        ...
        <div className="mt-auto pt-2">
          ...
          <span
            className="mx-auto mt-2.5 inline-flex w-[85%] items-center justify-center gap-1.5 whitespace-nowrap rounded-md bg-brand-whatsapp px-3 py-2 text-xs font-semibold text-white shadow-sm transition group-hover:brightness-95"
          >
