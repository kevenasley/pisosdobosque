...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "u3RuodWSQGWk8Qe5cjVEEVqNoHD-xLwczLRsLHO49Q8" },
      ...
      { property: "og:title", content: "Pisos do Bosque — Pisos com Preço Justo em Cachoeirinha/RS" },
      { name: "twitter:title", content: "Pisos do Bosque — Pisos com Preço Justo em Cachoeirinha/RS" },
      { name: "description", content: "Há mais de 20 anos com os pisos mais baratos da região: cerâmica, porcelanato, vinílicos, forro, louças e portas em Cachoeirinha/RS." },
      { property: "og:description", content: "Há mais de 20 anos com os pisos mais baratos da região: cerâmica, porcelanato, vinílicos, forro, louças e portas em Cachoeirinha/RS." },
      { name: "twitter:description", content: "Há mais de 20 anos com os pisos mais baratos da região: cerâmica, porcelanato, vinílicos, forro, louças e portas em Cachoeirinha/RS." },
    ],
    links: [
